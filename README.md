...
|---|---|---|
| [**property-testing**](https://github.com/rasuvaeff/property-testing) | Property-based testing for PHP — integrated shrinking (Hedgehog model), stateful / model-based testing; a Testo plugin. Hypothesis / fast-check / jqwik, but for PHP | [![v](https://img.shields.io/packagist/v/rasuvaeff/property-testing?style=flat-square&label=&color=4c1)](https://packagist.org/packages/rasuvaeff/property-testing) [![dt](https://img.shields.io/packagist/dt/rasuvaeff/property-testing?style=flat-square&label=&color=777BB4)](https://packagist.org/packages/rasuvaeff/property-testing) |
| [**yii3-mcp**](https://github.com/rasuvaeff/yii3-mcp) | MCP server for Yii3: expose CQRS handlers as LLM tools, auto-bridge OpenAPI → MCP, per-user RBAC + audit on AI access | [![v](https://img.shields.io/packagist/v/rasuvaeff/yii3-mcp?style=flat-square&label=&color=4c1)](https://packagist.org/packages/rasuvaeff/yii3-mcp) [![dt](https://img.shields.io/packagist/dt/rasuvaeff/yii3-mcp?style=flat-square&label=&color=777BB4)](https://packagist.org/packages/rasuvaeff/yii3-mcp) |
| [**bulkhead**](https://github.com/rasuvaeff/bulkhead) | Cross-process concurrency limiter: atomic slot acquisition via Redis Lua, APCu spinlocks; tested against real forked processes | [![v](https://img.shields.io/packagist/v/rasuvaeff/bulkhead?style=flat-square&label=&color=4c1)](https://packagist.org/packages/rasuvaeff/bulkhead) [![dt](https://img.shields.io/packagist/dt/rasuvaeff/bulkhead?style=flat-square&label=&color=777BB4)](https://packagist.org/packages/rasuvaeff/bulkhead) |
| [**yii3-outbox**](https://github.com/rasuvaeff/yii3-outbox) | Transactional outbox — reliable event delivery, no lost messages on crash | [![v](https://img.shields.io/packagist/v/rasuvaeff/yii3-outbox?style=flat-square&label=&color=4c1)](https://packagist.org/packages/rasuvaeff/yii3-outbox) [![dt](https://img.shields.io/packagist/dt/rasuvaeff/yii3-outbox?style=flat-square&label=&color=777BB4)](https://packagist.org/packages/rasuvaeff/yii3-outbox) |
| [**yii3-idempotency**](https://github.com/rasuvaeff/yii3-idempotency) | Idempotent HTTP APIs — safe request retries via `Idempotency-Key` | [![v](https://img.shields.io/packagist/v/rasuvaeff/yii3-idempotency?style=flat-square&label=&color=4c1)](https://packagist.org/packages/rasuvaeff/yii3-idempotency) [![dt](https://img.shields.io/packagist/dt/rasuvaeff/yii3-idempotency?style=flat-square&label=&color=777BB4)](https://packagist.org/packages/rasuvaeff/yii3-idempotency) |
| [**rector-datetime-immutable**](https://github.com/rasuvaeff/rector-datetime-immutable) | Rector rules migrating mutable `DateTime` → `DateTimeImmutable` — and auto-fixing the lost mutations the migration silently creates (`$d->modify()` throwing its result away) | [![v](https://img.shields.io/packagist/v/rasuvaeff/rector-datetime-immutable?style=flat-square&label=&color=4c1)](https://packagist.org/packages/rasuvaeff/rector-datetime-immutable) [![dt](https://img.shields.io/packagist/dt/rasuvaeff/rector-datetime-immutable?style=flat-square&label=&color=777BB4)](https://packagist.org/packages/rasuvaeff/rector-datetime-immutable) |
...
| **Delivery** | [yii3-outbox](https://github.com/rasuvaeff/yii3-outbox) (+ `-db`, `-clickhouse`) · [yii3-webhooks](https://github.com/rasuvaeff/yii3-webhooks) (+ `-db`) · [yii3-outbox-webhooks-bridge](https://github.com/rasuvaeff/yii3-outbox-webhooks-bridge) |
